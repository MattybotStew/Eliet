...
| Responsive footer: brand/about block + 3 link groups; stacked on phones, 2×2 at small/tablet widths, true 4-across on desktop | Elementor inner sections / containers with responsive column settings |
| Newsletter signup form                                                                                                        | **Mailchimp for WordPress** or Elementor Form widget                  |
| Footer chrome: Dalton HQ contact, builder links, copyright / powered-by row                                                   | Text Editor, Button/Icon List, and utility links widgets              |
...
| **Used on:** Finance plus support/info pages that use the compact treatment in the final prototype (verify current prototype page before building) | Shortcode or template           |
...
| USA Team (team member cards)        | Elementor section with Image + Text for each team member; final prototype uses 1/2/4 responsive grid behavior |
...
| Breadcrumb + dark zip/radius search panel                                                             | Elementor section with form controls styled to match the prototype                                   |
| Dealer map image                                                                                      | Media/image block or map embed placeholder matching prototype proportions                            |
| Dealer results cards / list                                                                           | Dealer locator plugin results template or Elementor cards; keep orange tier badges and CTA hierarchy |
| WhyElietBanner (full shared banner, not compact)                                                      | Global Widget                                                                                        |
| **Page template:**                                                                                    | **Astra: Default**                                                                                   |
| **Note:** Real dealer list/data is still pending from client; current prototype rows are placeholders |                                                                                                      |
...
| Design System / Navigation Lab | _(prototype only)_  | Builder reference views — not production WP pages; use for Astra header + design tokens |
...
_Generated 2026-07-24 from prototype source. Update this document as new client content arrives or WordPress build decisions change._
